 ...
 * @author Camilo
 */
public class ChargingScreenJFrame extends javax.swing.JFrame {
     ...
     */
    public ChargingScreenJFrame(Main principal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChargingScreenJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //  new ChargingScreenJFrame().setVisible(true);
            }
        });
    }
...
//                            principal.setLocationRelativeTo(ChargingScreenJFrame.this);
                            //dispose();
                            break;
                    }
                    Thread.sleep(100);
                ...
                Logger.getLogger(ChargingScreenJFrame.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
