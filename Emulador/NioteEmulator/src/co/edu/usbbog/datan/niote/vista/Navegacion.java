...
return image;
   ...
   /* protected void chargingScreen() {
    ...
    protected void goCreateProject() {
        crearProyectoJPanel = new CrearProyectoJPanel(principal);
    ...
    public void goAddNewNode() {
        agregarNodoIoTJPanel = new AgregarNodoIoTJPanel(principal);
    ...
    protected void goAboutUs() {
        sobreNosotrosJPanel = new SobreNosotrosJPanel(principal);
    ...
    protected void goReportError() {
        notificarErrorJPanel = new NotificarErrorJPanel(principal);
